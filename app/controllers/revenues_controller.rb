class RevenuesController < ApplicationController
  ...
  def calculate_monthly_statistics
    ...
    @monthly_revenue = Bill.where(billing_date: @start_date..@end_date).sum(:total_amount)
  ...
  def prepare_yearly_data
    ...
    12.times do |i|
      ...
      month_revenue = Bill.where(billing_date: month.beginning_of_month..month_end).sum(:total_amount)
  ...
  def calculate_profits_by_building
    ...
    buildings.each do |building|
      ...
      # Calculate revenue for this building
