class SmartDevicesController < ApplicationController
  before_action :set_smart_device, only: [:show, :edit, :update, :destroy, :device_info, :device_functions, :device_logs]
  ...
  def debug_api
    # Cho phép thử với time offset khác từ tham số query
    ...
    begin
      ...
      # Nếu thành công với một time_offset cụ thể, đề xuất cập nhật cấu hình
